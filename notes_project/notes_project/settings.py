...
# For local dev or PythonAnywhere
ALLOWED_HOSTS = ['*']
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # looks in templates/ parallel to manage.py
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                'django.template.context_processors.request',  # important for auth forms
